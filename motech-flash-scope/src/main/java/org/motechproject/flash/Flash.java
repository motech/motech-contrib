...
public class Flash {
    ...
    static boolean shouldBeConsumed(String attributeName) {
        return attributeName.startsWith(FLASH_OUT_PREFIX);
    }

    static boolean shouldBeDestroyed(String attributeName) {
        return attributeName.startsWith(FLASH_IN_PREFIX);
    }

    static void transfer(String attributeName, String attributeValue, HttpServletRequest request) {

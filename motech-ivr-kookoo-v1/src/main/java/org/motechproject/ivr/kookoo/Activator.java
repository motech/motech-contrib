...
public class Activator implements BundleActivator {
    ...
    private static final String CONTEXT_CONFIG_LOCATION = "applicationIvrKookooBundle.xml";
    ...
    public static class KookooApplicationContext extends OsgiBundleXmlWebApplicationContext {

        public KookooApplicationContext() {
            super();
    ...
    private void serviceAdded(HttpService service) {
        try {
            ...
            dispatcherServlet.setContextClass(KookooApplicationContext.class);

CREATE DATABASE IF NOT EXISTS motechaggregator;
use motechaggregator;
CREATE TABLE IF NOT EXISTS INT_MESSAGE (MESSAGE_ID CHAR(36) NOT NULL PRIMARY KEY,	REGION VARCHAR(100), CREATED_DATE DATETIME NOT NULL, MESSAGE_BYTES BLOB) ENGINE=InnoDB;

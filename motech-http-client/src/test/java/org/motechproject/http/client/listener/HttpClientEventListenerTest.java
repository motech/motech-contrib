...
public class HttpClientEventListenerTest {
    ...
    @Test
    public void shouldReadFromQueueAndMakeAHttpCallForPut() throws IOException {
    ...
    public void shouldReadFromQueueAndMakeAHttpDeleteCall() throws IOException {
        ...
        ArgumentCaptor<HttpEntity> requestEntityCaptor = ArgumentCaptor.forClass(HttpEntity.class);
        verify(restTempate).exchange(eq(deleteUrl), eq(HttpMethod.DELETE), requestEntityCaptor.capture(), eq(Object.class));

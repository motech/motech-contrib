...
public class RetryServiceImpl implements RetryService {
    ...
    public void schedule(RetryRequest retryRequest) {
        ...
        schedulerService.scheduleRepeatingJob(new RepeatingSchedulableJob(motechEvent(retryRecord, retryRequest, jobIdKey(externalId, groupName, retryName)),
                retryStartTime.toDate(), endTime(retryStartTime, retryRecord.retryCount(), retryRecord.retryInterval()),
                retryRecord.retryCount(), intervalInMillis(retryRecord), false));
    }
